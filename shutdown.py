# -*- coding: utf-8 -*-
"""
Created on Fri May 17 13:30:50 2019
...
from PyQt5.QtWidgets import QWidget, QLabel, QPushButton, QVBoxLayout,QHBoxLayout,QSlider,QRadioButton,QSizePolicy
...
class QUnFrameWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.label.setStyleSheet("QLabel{color:rgb(0,0,0,255);font-size:50px;font-weight:normal;font-family:Arial;}")
    ...
    def openChange(self, state):
        ...
        if state == True:
            print("open")
            subprocess.call("shutdown -s -t "+str(self.hour*3600+self.minute*60), creationflags=CREATE_NO_WINDOW)
        else:
            print("close")
...
if __name__ == "__main__":
    ...
    app.setStyleSheet(open("./app.qss").read())
